  ...
  <div class="static-page">
    <div class="static-hero">
      ...
      <div class="container">
        ...
        <p class="hero-sub">{{ content.tagline || 'Please read these terms carefully before using our services.' }}</p>
...
.hero-title { font-family: var(--font-display); font-size: clamp(2.4rem, 6vw, 4.5rem); letter-spacing: 0.02em; color: var(--text-primary); margin: 0 0 12px; line-height: 1; }
