  ...
  <div class="static-page">
    <div class="static-hero">
      ...
      <div class="container">
        ...
        <p class="hero-sub">{{ content.tagline || 'Trusted journalism, delivered live.' }}</p>
      </div>
    </div>
...
const content = ref({ tagline: '', body: '' })
...
.hero-sub { font-size: 1rem; color: var(--text-muted); font-family: var(--font-body); }
...
.static-content :deep(h2) { font-family: var(--font-display); font-size: 1.6rem; color: var(--text-primary); margin: 2em 0 0.6em; letter-spacing: 0.02em; }
...
.static-content :deep(li) { color: var(--text-secondary); }
</style>
