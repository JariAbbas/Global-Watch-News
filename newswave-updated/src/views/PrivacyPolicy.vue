  ...
  <div class="static-page">
    <div class="static-hero">
      ...
      <div class="container">
        ...
        <p class="hero-sub">{{ content.tagline || 'How we collect, use, and protect your data.' }}</p>
...
onMounted(async () => {
  try {
    ...
    console.error('PrivacyPolicy load error:', e)
  } finally {
    loading.value = false
  }
})
...
.static-content :deep(h2) { font-family: var(--font-display); font-size: 1.6rem; color: var(--text-primary); margin: 2em 0 0.6em; letter-spacing: 0.02em; padding-bottom: 8px; border-bottom: 1px solid var(--border); }
